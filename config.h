...
static const char *fonts[]          = { "Iosevka Custom:size=12", "Hack Nerd Font Mono:size=14" };
...
// font colour
static const char col_white1[]       = "#d5c4a1";
...
static const Key keys[] = {
	...
	{ MODKEY,						XK_s,	   spawn,          SHCMD("changesink") },
	{ MODKEY|ShiftMask,				XK_c,	   spawn,          SHCMD("connectbluetoothdevice") },
